    ...
    private void _on_ftp_btn_change(boolean b) {
        ...
        if (b) {
            ...
            if (ftp_username.getText().toString().length() > 8) {
                ...
                Intent intent = new Intent(FTPActivity.this, Dialog.class);
                ...
                try {
                    ...
                    textView.setText("FTP服务已在 " + ToolUtils.getLocalIPAddress(this) + ":2221 上开启");
            ...
            findViewById(R.id.ftp_username).setEnabled(true);
            findViewById(R.id.ftp_password).setEnabled(true);
        }
    }
